        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {apiSections.map((section) => (
            <Link
              ...
              className="group relative bg-[#18181b80] border border-[#A1A1A120] rounded-xl p-6 transition-all cursor-pointer"
            >
              <div className="relative flex flex-col h-full">
                <div
                  className={`inline-flex p-3 bg-[#007acc]/10 text-[#66a3ff] rounded-lg mb-4 w-fit`}
                >
                  {section.icon}
                </div>
                ...
                <div className="flex items-center text-[#007acc70] font-medium group-hover:gap-2 transition-all mt-auto">
                  <span>Explore</span>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <Link
                ...
                className="text-[#007acc70] text-sm font-medium hover:underline"
              >
                View Guide →
              </Link>
            </div>
