...
import { Book, Users, Wallet, ArrowLeftRight, Settings, Zap, ArrowRight, Key } from 'lucide-react';
  ...
  const apiSections = [
    {
      ...
      description: 'Learn the basics of HASA API, authentication, and quick start guide',
    ...
    },
    {
      ...
      topics: ['Get Profile', 'Update Settings', 'Get Limits', 'Manage API Keys']
    },
    {
      id: 'users',
      title: 'Users API',
      ...
      topics: ['Create User', 'List Users', 'Get User', 'Update User', 'Delete User']
    },
    {
      id: 'wallets',
      title: 'Wallets API',
      ...
      topics: ['Create Wallet', 'List Wallets', 'Get Wallet', 'Sync Balance', 'Transfer Funds']
    },
    {
      id: 'transactions',
      ...
      topics: ['Process Transfer', 'List Transactions', 'Get Transaction', 'Transaction Stats']
    }
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#007acc]/10 border border-[#007acc]/30 rounded-full mb-8">
              ...
              <span className="text-sm text-[#66a3ff] font-medium">API v1.0 Documentation</span>
            </div>
            
            <h1 className="text-5xl md:text-6xl font-bold mb-6">
              Build with
              <span className="bg-gradient-to-r from-[#66a3ff] to-[#007acc] bg-clip-text text-transparent"> HASA API</span>
            </h1>
            
            <p className="text-xl text-gray-400 mb-8">
              Comprehensive documentation for integrating wallet infrastructure into your application. 
              Choose an API section below to get started.
            </p>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {apiSections.map((section) => (
            ...
            >
              ...
              <div className={`absolute inset-0 bg-gradient-to-br ${section.color} opacity-0 group-hover:opacity-10 rounded-xl transition-opacity`}></div>
              
              <div className="relative">
                <div className={`inline-flex p-3 bg-gradient-to-br ${section.color} rounded-lg mb-4`}>
                  {section.icon}
                </div>
        ...
        <div className="bg-gradient-to-r from-[#007acc]/10 to-[#007acc]/5 border border-[#007acc]/20 rounded-xl p-8">
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <Link href="/docs/reference#authentication" className="text-[#66a3ff] text-sm font-medium hover:underline">
                View Guide →
              </Link>
            </div>
            ...
            <div>
              ...
              <Link href="/docs/reference#quick-start" className="text-[#66a3ff] text-sm font-medium hover:underline">
                Start Building →
              </Link>
            </div>
            ...
            <div>
              ...
              <Link href="/docs/reference" className="text-[#66a3ff] text-sm font-medium hover:underline">
                View Examples →
              </Link>
            </div>
          </div>
